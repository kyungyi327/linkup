            ...
            conn.execute(
                ...
                INSERT INTO User_Profile
                    (id, nickname, avatar_path, gender, birth_year, height_cm,
                     weight_kg, job_type, goals, goal_duration_weeks, weekly_frequency,
                     pain_points, pushup_max, plank_max_sec, squat_max, notification_enabled)
                VALUES
                    (:id, :nickname, :avatar_path, :gender, :birth_year, :height_cm,
                     :weight_kg, :job_type, :goals, :goal_duration_weeks, :weekly_frequency,
                     :pain_points, :pushup_max, :plank_max_sec, :squat_max, :notification_enabled)
                ON CONFLICT(id) DO UPDATE SET
                    ...
                    job_type=:job_type, goals=:goals, goal_duration_weeks=:goal_duration_weeks,
